...
public class IconUtils {
    ...
    public static ImageIcon getMarkedBallIcon() {
        return getImageIcon(TextsDao.getFilePath("img.point_was"));
    }

    public static ImageIcon getUnmarkedBallIcon() {
        return getImageIcon(TextsDao.getFilePath("img.point_before"));
    }

    public static ImageIcon getGoodBallIcon() {
        return getImageIcon(TextsDao.getFilePath("img.point_ok"));
    }

    public static ImageIcon getBadBallIcon() {
        return getImageIcon(TextsDao.getFilePath("img.point_bad"));
    }

    public static ImageIcon getLoadingIcon() {
        String iconsFolder = "/program_images/";
        URL imageSrc = IconUtils.class.getResource(iconsFolder + TextsDao.getFilePath("img.loading"));
        return new ImageIcon(imageSrc);
    }

    public static ImageIcon getLogo() {
        String logo = TextsDao.getFilePath("logo");
